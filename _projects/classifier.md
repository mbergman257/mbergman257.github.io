...
- Major skills for this project include: Python, PyTorch, Ubuntu, Git, deep learning theory, and probability.
...
I used Python and PyTorch for all training and inference code, as well as some basic bash scripts to help automate the trials. The training environment was in Ubuntu. I used quite a bit of deep learning theory from my coursework to design the model architecture.
